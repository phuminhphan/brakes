...
#   "brand_desc": "Crossed Drilled rotors reduce the heat that builds on the rotor by up to 105° F. Cross-drilled rotors are also chamfered, which reduces the potential for cracking.",
